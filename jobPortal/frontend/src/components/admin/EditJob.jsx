...
const EditJob = () => {
    ...
    // Fetch job details by ID on mount
    useEffect(() => {
    ...
    requirements: Array.isArray(job.requirements) ? job.requirements.join(",") : job.requirements, // <- FIXED
    salary: job.salary.toString(), // <- Ensure it's a string
    location: job.location,
    jobType: job.jobType,
    experience: job.experienceLevel, // <- FIXED
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            console.log("Payload being sent:", input);
